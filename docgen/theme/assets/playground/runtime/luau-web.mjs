// luau-web 1.4.0. Local adaptation: always select Asyncify so protected
// Luau calls behave consistently in browsers with JSPI. See PROVENANCE.json.
import InternalLuauWasmModule from './Luau.Web.Asyncify.mjs';
